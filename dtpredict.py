...
def predict_1(data1,data2,i,j):
    clf1 = DecisionTreeRegressor(criterion='mse', min_samples_leaf=j,max_depth=i)
    clf2= DecisionTreeRegressor(criterion='mse', min_samples_leaf=j,max_depth=i)
    clf3 = DecisionTreeRegressor(criterion='mse', min_samples_leaf=j,max_depth=i)
    ...
    train_forward=data1.loc[:,['forward_count']]
    train_comment=data1.loc[:,['comment_count']]
    train_like=data1.loc[:,['like_count']]
